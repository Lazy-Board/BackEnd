    ...
    public List<StockDto> NaverScrap() {
        ...
        try {
            for (int i = 0; i < 10; i++) {
                ...
                String type = totalStockInfo.get(3).text().split(" ")[3];               // 타입

                if ((Objects.equals(stockInfo[17], "+"))) {
                    dayRange = new StringBuilder(stockInfo[17] + dayRange + "%");
                    diffAmount.insert(0, "▲ ");
                } else if ((Objects.equals(stockInfo[17], "-"))) {
                    dayRange = new StringBuilder(stockInfo[17] + dayRange + "%");
                    diffAmount.insert(0, "▼ ");
                } else if (Objects.equals(type, "보합")) {
                    diffAmount.insert(0, "-");
                }
