        ...
        try {
            ...
            while (true) {
                ...
                for (int i = 0; i < hotClipArray.size(); i++) {
                    ...
                    youtube.setContentName(baseObject.getAsJsonObject("title").getAsJsonArray("runs").get(0).getAsJsonObject().get("text").getAsString());
                    youtube.setChannelName(baseObject.getAsJsonObject("longBylineText").getAsJsonArray("runs").get(0).getAsJsonObject().get("text").getAsString());
                    ...
                    youtube.setCreatedAt(baseObject.getAsJsonObject("publishedTimeText").get("simpleText").getAsString());
                    youtube.setLength(baseObject.getAsJsonObject("lengthText").get("simpleText").getAsString());
                    youtube.setNumViewers(baseObject.getAsJsonObject("viewCountText")
